<?php
    ...
    if(empty($_SESSION['id'])){
        ...
        if($conn->connect_error){
            ...
            //query
            $query="INSERT INTO items(user_id,title,price,city,category,date,contact,description,image) VALUES(".$_SESSION['id'].",'".$title."','".$price."','".$city."','".$category."','".date("Y-m-d")."','".$contact."','".$description."','".$target_file."')";
            $conn->query($query);
