...
<div class="login-box">
  ...
  <form action="register.php" method = "POST">
    ...
    <div class="user-box">
     <input required="required" type="text" name="name"/><label>Name</label>
</div>
    <div class="user-box">
        <label>City</label>
      </div>
      ...
      <div class="user-box">
        ...
        <div class="user-box">
        <input required="required" type="password" name="password"/><label>Password</label>
</div>
        <div class="user-box">
        <input required="required" type="password" name="password-retype"/><label>Retype-Password</label>
</div>
